...
pipeline {
    ...
    environment {
        ...
        DOCKER_IMAGE_NAME = 'Akanksha925/qbshop-app'
        DOCKER_MIGRATION_IMAGE_NAME = 'Akanksha925/qbshop-migration'
    ...
    stages {
        ...
        stage('Clone Repository') {
            steps {
                script {
                    clone("https://github.com/Akankshas-git/Qualibytes-Ecommerce.git", "dev")
                }
            }
        }
